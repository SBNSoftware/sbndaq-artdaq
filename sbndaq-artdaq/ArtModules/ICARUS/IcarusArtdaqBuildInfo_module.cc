...
namespace icarus
{
   ...
   */
  typedef artdaq::BuildInfo<&instanceName, artdaqcore::GetPackageBuildInfo, artdaq::GetPackageBuildInfo, sbndaqcore::GetPackageBuildInfo, sbndaq::GetPackageBuildInfo> IcarusArtdaqBuildInfo;
