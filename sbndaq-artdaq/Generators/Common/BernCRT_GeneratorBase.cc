...
void sbndaq::BernCRT_GeneratorBase::Initialize() {
  ...
  max_time_with_no_data_ns_   = 1'000'000UL * ps_.get<uint64_t>("max_time_with_no_data_ms", 10); //set to 0 to disable warning message
  max_tolerable_t0_           = ps_.get<uint64_t>("max_tolerable_t0_", 1'000'1000'000); //set to 1<<30 (or more) to disable error message
