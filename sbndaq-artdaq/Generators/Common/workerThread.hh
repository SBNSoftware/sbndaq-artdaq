...
class WorkerThread {
 public:
  static WorkerThreadUPtr createWorkerThread(WorkerThreadFunctorUPtr& functor, unsigned int usec_delay_if_failed = 10e3,
 ...
 private:
  explicit WorkerThread(WorkerThreadFunctorUPtr& functor, unsigned int usec_delay_if_failed = 10e3,
                        unsigned int max_stop_tries = 10);
