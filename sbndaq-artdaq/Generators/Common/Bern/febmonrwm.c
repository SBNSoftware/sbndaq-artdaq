...
void usage()
{
 printf("Connects to data stream from running febdrv at a given data socket and prints out missing beam triggers.\n Usage: ");
 printf("febmonrwm <socket>\n");
 printf("Example:  fenmonrwm tcp://localhost:5556 \n");
