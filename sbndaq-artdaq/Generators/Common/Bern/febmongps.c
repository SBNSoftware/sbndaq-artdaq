...
void usage()
{
 printf("Connects to data stream from running febdrv at a given data socket and prints out missing GPS PPSes.\n Usage: ");
 printf("febmongps <socket>\n");
 printf("Example:  fenmongps tcp://localhost:5556 \n");
