...
#define BUF_NO (16) //256               -- 32 ok
#define BUF_SIZE (32 * 1024)//32 * 1024 -- 64 *1024 ok	
...
static char target_dir[200]= "/e/h.0/localdev/readout/data1/OVDAQ/DATA/"; //default data folder
static char target_path[200]= "OVDAQ/DATA/"; // default relative path
