...
print("DataPath=$DataPath,Disk=$disk\n");
...
# print "\n";
$full_path = "/e/h.0/localdev/readout/data1/OVDAQ/DATA/Run_${run}";

my $full_path_temp = "$full_path";
my $homedir = "/e/h.0/localdev/readout";
